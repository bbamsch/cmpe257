...
def main():
    ...
    #savefile(notes, "model/notes.pkl")
    #savefile(notes_by_file, "model/notes-by-file.pkl")

    notes = loadfile("model/notes.pkl")
    notes_by_file = loadfile("model/notes-by-file.pkl")
...
def train_model(model, x, y, model_file, epochs=500, batch_size=512):
